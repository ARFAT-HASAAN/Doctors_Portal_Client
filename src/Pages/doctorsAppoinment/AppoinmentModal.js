    ...
    <Grid item xs={13} sm={13} md={6} lg={4}>
      <Paper sx={{}} elevation={3}>
        <Stack sx={{ textAlign: 'center', margin: 'auto' }} spacing={2}>
          ...
          <h4>Price:$ {appoinment.price}</h4>
          <h4>{appoinment.watchTime}</h4>
          <h6>{appoinment.space} SPACE AVAIABLE</h6>

          <button className="btnn" onClick={handleClickOpen}>
            Book Appoinment
          </button>
        </Stack>
      </Paper>
